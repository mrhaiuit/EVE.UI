<%@ Page Language="C#" MasterPageFile="~/Layout/MasterPage.master" AutoEventWireup="true" CodeFile="SECTION_TruongHoc.aspx.cs" Inherits="ASP_Page_Default" %>
    ...
    <script>
        {
            ...
            function OpenModal_EditTruongHoc() {
                $("#btnModalSave").attr('onclick', 'EditTruongHoc();');
                    ...
                    <div class="card">
                        <div class="header">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-3 col-md-3 col-sm-7 col-xs-7">
                                    <select class="form-control" id="slPhongGiaoDuc" style="width: 100%;">
                                        <option>-- Chọn phòng giáo dục --</option>
                                        <option value='0'>Phòng A</option>
                                        <option value='1'>Phòng B</option>
                                        <option value='2'>Phòng C</option>
                                        <option value='3'>Phòng D</option>
                                        <option value='4'>Phòng E</option>
                                    </select>
                                </div>
                            </div>
                            <div class="row"> 
                                ...
                                <div class="col-lg-10 col-md-10 col-sm-8 col-xs-8 align-right">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="row">
                                <div class="col-md-6 col-lg-6">
                                    <select class="form-control" id="slSoGiaoDuc_modal" style="width: 100%;">
                                        <option>-- Chọn sở giáo dục --</option>
                                    </select>
                                </div>
                                <div class="col-md-6 col-lg-6">
                            ...
                            <div class="row">
                                <div class="col-md-3 col-lg-3">
                                    <select class="form-control" id="slCapTruong_modal" style="width: 100%;">
...
<asp:Content ID="Content3" ContentPlaceHolderID="FooterMaster" runat="Server">
    ...
    <script>
        ...
        $("#slSoGiaoDuc_modal,#slPhongGiaoDuc_modal, #slSoGiaoDuc,#slPhongGiaoDuc,#slTinhThanh,#slQuanHuyen,#slPhuongXa").select2();
