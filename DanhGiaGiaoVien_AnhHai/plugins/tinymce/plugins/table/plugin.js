...
// Included from: js/tinymce/plugins_GiaoDien2/table/classes/Utils.js
...
// Included from: js/tinymce/plugins_GiaoDien2/table/classes/TableGrid.js
...
// Included from: js/tinymce/plugins_GiaoDien2/table/classes/Quirks.js
...
// Included from: js/tinymce/plugins_GiaoDien2/table/classes/CellSelection.js
...
// Included from: js/tinymce/plugins_GiaoDien2/table/classes/Dialogs.js
	...
	return function(editor) {
		...
		self.table = function(isProps) {
			...
			function onSubmitTableForm() {
				...
				editor.undoManager.transact(function() {
					if (!tableElm) {
						tableElm = editor.plugins_GiaoDien2.table.insertTable(data.cols || 1, data.rows || 1);
					}
...
// Included from: js/tinymce/plugins_GiaoDien2/table/classes/ResizeBars.js
...
// Included from: js/tinymce/plugins_GiaoDien2/table/classes/Plugin.js
