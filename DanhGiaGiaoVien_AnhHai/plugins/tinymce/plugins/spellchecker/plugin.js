...
// Included from: js/tinymce/plugins_GiaoDien2/spellchecker/classes/DomTextMatcher.js
...
// Included from: js/tinymce/plugins_GiaoDien2/spellchecker/classes/Plugin.js
...
define("tinymce/spellcheckerplugin/Plugin", [
	...
	PluginManager.add('spellchecker', function(editor, url) {
		 ...
		 *
		 * @example
		 * editor.plugins_GiaoDien2.spellchecker.markErrors({
		 *     dictionary: true,
		 *     words: {
